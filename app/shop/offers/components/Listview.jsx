...
import { ChartNoAxesCombinedIcon, Edit2Icon, Trash2Icon } from "lucide-react";
...
export default function Listview() {
  ...
  if (!data || data.length === 0) {
    return <div className="text-center py-6 text-gray-400">No Offer found</div>;
  }
  ...
  return (
    <div className="w-full flex-1 flex flex-col gap-6 px-3 sm:px-6 pb-10">
      ...
      <div className="flex justify-end">
        <Link
          href="/shop/offers/analytics"
          className="inline-flex items-center gap-2 bg-white border border-gray-300 px-4 py-2 rounded-lg text-sm font-medium shadow-sm hover:bg-gray-100 hover:border-gray-400 transition"
        >
              ...
              <tr key={offer.id} className="bg-white shadow rounded-lg">
                ...
                <td className="text-center rounded-r-lg">
                  <div className="flex justify-center items-center gap-3">
                    ...
                    <button
                      onClick={() =>
                        router.push(`/shop/offers/Form?id=${offer.id}`)
                      }
        ...
        {data?.map((offer, index) => (
          ...
          >
            ...
            <div className="text-sm text-gray-600 space-y-1">
              <p>
                <b>Code:</b> {offer.offerCode}
              </p>
              <p>
                <b>Type:</b> {offer.type}
              </p>
              <p>
                <b>Value:</b> {offer.discountValue}
              </p>
              <p>
                <b>Applicable On:</b> {offer.applicableOn}
              </p>
            </div>
            ...
            <div className="flex justify-end items-center gap-4 pt-2">
              {/* Edit */}
              <button
                onClick={() => router.push(`/shop/offers/Form?id=${offer.id}`)}
