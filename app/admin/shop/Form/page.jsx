...
export default function Page() {
    ...
    const handleSubmit = async () => {
        setIsLoading(true);
        try {
            await createNewShop({ data: data, logo: logo, images: images, bannerImage: bannerImage });
            setData({
                name: "",
                ownerName: "",
                shopNumber: "",
    ...
    const handleUpdate = async () => {
        setIsLoading(true);
        try {
            await UpdateShop({ data: data, logo: logo, images: images, bannerImage: bannerImage });
            setData({
                name: "",
                ownerName: "",
                shopNumber: "",
    ...
    return (
        <div className="flex-1 flex flex-col gap-5 rounded-xl p-3 sm:p-8 md:p-12 bg-gray-50">
            <div className="flex items-center justify-between">
                <h1 className="text-2xl font-semibold"> {id ? "Update" : "Create"} Shop</h1>
            </div>
