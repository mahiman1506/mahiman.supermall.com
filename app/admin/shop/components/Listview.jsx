                                ...
                                <td className="text-center">
                                    <div className="flex flex-col items-center gap-1">
                                        <a
                                            ...
                                            className="inline-flex items-center gap-2 text-green-700 font-medium bg-green-50 px-2 py-1 rounded-md hover:bg-green-100 transition"
                                        >
                        ...
                        <div className="flex items-center justify-between gap-5">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">{shop.ownerName || "N/A"}</p>
                                </div>
                            </div>
