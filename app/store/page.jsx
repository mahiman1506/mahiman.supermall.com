            ...
            <section className="max-w-7xl mx-auto px-4 py-25">
                ...
                {authLoading ? (
                    ...
                    <div className="text-center py-20">
                        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Please Login First</h2>
                        <p className="text-gray-600 mb-6">You need to be logged in to view the shops</p>
                        <button
